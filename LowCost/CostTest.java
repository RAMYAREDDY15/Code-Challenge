...
import com.ramya.lowcost.view.LowestCostActivity;
...
@Config(constants = BuildConfig.class, sdk = 21,
        manifest = "src/main/AndroidManifest.xml", packageName = "com.ramya.lowcost")
...
public class CostTest {
    ...
    public void clickingGoForVariousInputs() {
        ...
        customGridContents.setText("3 4 1 2 8 6 \n" +
                "6 1 8 2 7 4 \n" + "5 9 3 9 9 5 \n" + "8 4 1 3 2 6 \n" + "3 7 2 8 6 4");
        getViewFromActivity(R.id.go_button).performClick();
